                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                          ...
                          //  updateUI(user);
                            ...
                            Toast.makeText(getApplicationContext(),"something when wrong..", Toast.LENGTH_SHORT);
                            //  Snackbar.make(findViewById(R.id.loa), "Authentication Failed.", Snackbar.LENGTH_SHORT).show();
                          //  updateUI(null);
                        }
